...
exports.getArbitrageRaydiumMeteoraAgentConfig = getArbitrageRaydiumMeteoraAgentConfig;
exports.getReflectionBTCETCSOLAnalyticsAgentConfig = getReflectionBTCETCSOLAnalyticsAgentConfig;
exports.getReflectionATHPumpFunAgentConfig = getReflectionATHPumpFunAgentConfig;
const enums_1 = require("../enums");
function getArbitrageRaydiumMeteoraAgentConfig() {
    const mainPrompt = `
  ...
  `;
    return {
        type: enums_1.EAgentType.PERMANENT,
        name: 'permanent',
        id: 'permanent',
        prompt: mainPrompt,
...
function getReflectionBTCETCSOLAnalyticsAgentConfig() {
...
function getReflectionATHPumpFunAgentConfig() {
...
function getNewPumpFunTokens({ minMarketCap }) {
    return new Promise((resolve) => {
        setTimeout(() => {
...
function getPricesForCryptoPairs({ tickers }) {
    return new Promise((resolve) => {
        setTimeout(() => {
...
function getCryptoNews({ tickers }) {
    return new Promise((resolve) => {
        setTimeout(() => {
...
function comparePrices({ tickers }) {
    return new Promise((resolve) => {
        setTimeout(() => {
            resolve('Prices for crypto pairs fetched');
        }, 1000);
